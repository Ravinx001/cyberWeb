            ...
            <div class="col">
                <div class="progress" role="progressbar" aria-label="Animated striped example" aria-valuenow="75"
                    ...
                    <div class="progress-bar progress-bar-striped progress-bar-animated text-dark"
                        style="width: 30%; background-color: #0bf5ea;">30% Completed</div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card mb-4" style="background-color: #1a1a1a; border-color: #333;">
                            ...
                            <div class="card-header text-center" style="background-color: #2a2a2a; border-bottom-color: #333; color: white;">
                                <h5 class="my-2">What is the primary objective of the Acceptable Use Policy (AUP) in the EISP ?</h5>
                            </div>
                                    ...
                                    <div class="col-9 offset-3 d-flex justify-content-start">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="flexRadioDefault1">
                                                a) To define company dress code for employees.
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-4 col-9 offset-3 d-flex justify-content-start">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="flexRadioDefault2">
                                                b) To outline acceptable and prohibited activities when using company resources.
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-4 col-9 offset-3 d-flex justify-content-start">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="flexRadioDefault3">
                                                c)  To specify procedures for requesting vacation time.
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-4 col-9 offset-3 d-flex justify-content-start">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="flexRadioDefault4">
                                                d) To assign employee roles and responsibilities.
                                            </label>
                                        </div>
                                    </div>
                                </div>
